 ...
 *
 * 
 * As configurações contidas neste arquivo foram geradas pela IDE ao setar
 * alguns registradores.
 *  Os registradores que não foram setados possuem valores padrão.
*/
...
#define Baud_value (((float)(F_CPU)/(float)baud_rate)-1)//cálculo da taxa de transmissão serial para UART
