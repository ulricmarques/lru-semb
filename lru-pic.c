...
int lru(int frames[], int num_frames, int num_referencias, int referencias[]){
    ...
    short int ultimo_acesso[4]; /* Declara��o do vetor de frames, de tamanho m�ximo 50,
...
//    while (1);
    ...
    while (1) {
        ...
        //int referencias[] = {1,2,3,4,5,6,7,8,9,7}; //Declar��o do vetor de refer�ncias, de tamanho m�ximo 3000.
        int referencias[40];
        int frames[4];        //Declara��o do vetor de frames, de tamanho m�ximo 50.
        int cont_faltas;       //Vari�vel que guardar� a quantidade de faltas de p�gina.

       
        cont_faltas = lru(frames, 4, 10, referencias); /* Chamada da fun��o de simula��o, 
